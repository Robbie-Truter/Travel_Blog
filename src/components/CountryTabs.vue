...
import { getTabPostsByCountry } from "@/util/services/countries/getTabPostsByCountry";
    ...
    >
      ...
      >
        <img
          ...
          class="object-cover transition duration-200 ease-in-out h-80 w-80 hover:scale-105 hover:shadow-2xl"
        />
        <figcaption
